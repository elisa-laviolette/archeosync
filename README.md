...
4. Click **Prepare Global Project** to create one project with empty editable layers (objects, features, small finds, and optional alternative objects), plus read-only **recording areas** and **extra field layers** filtered to the extent for context (no project variables or form defaults)
